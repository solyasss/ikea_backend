...
namespace ikea_data.Data.Migrations
{
    ...
    [Migration("20250701192843_AddSqlCacheTable")]
    partial class AddSqlCacheTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ikea_data.Data.IkeaDbContext+SqlServerCacheEntry", b =>
                {
            ...
            modelBuilder.Entity("ikea_data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderNumber = "Order-1",
                            ProductId = 1,
                            ReceiveDate = new DateTime(2025, 5, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TotalSum = 59.99m,
                            UserId = 2
                        },
                        new
                        {
                            ...
                            OrderNumber = "Order-2",
                            ProductId = 2,
                            ReceiveDate = new DateTime(2025, 5, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TotalSum = 19.99m,
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("ikea_data.Models.UserCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ikea_data.Models.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
